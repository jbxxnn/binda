...
export const env = {
  ...
  whatsappAddProductFlowId: process.env.WHATSAPP_ADD_PRODUCT_FLOW_ID,
  whatsappUpdateProductFlowId: process.env.WHATSAPP_UPDATE_PRODUCT_FLOW_ID,
  whatsappFeedbackFlowId: process.env.WHATSAPP_FEEDBACK_FLOW_ID,
