      ...
      <div className="grid gap-4 bg-[#ccd6c24d] p-6 rounded-sm border border-brand-tropical">
        <div>
          <div className="border-brand-tropical pb-12 px-0 md:px-8">
            <div className="text-2xl">Performance Metrics</div>
           ...
           <div className="grid md:grid-cols-4 relative gap-12 md:gap-0">
             ...
             <div className="p-4 md:pl-8 h-20 flex flex-col justify-center relative">
              ...
              <div className="text-3xl text-green-900 flex items-center gap-2">
             ...
             <div className="p-4 md:pl-8 h-20 flex flex-col justify-center relative">
              ...
              <div className="text-3xl text-red-900 flex items-center gap-2">
             ...
             <div className="p-4 md:pl-8 h-20 flex flex-col justify-center relative">
              ...
              <div className="text-3xl text-blue-900 flex items-center gap-2">
             ...
             <div className="p-4 md:pl-8 h-20 flex flex-col justify-center relative">
              ...
              <div className="text-3xl text-orange-900 flex items-center gap-2">
        ...
        <div className="space-y-4 mt-4">
          <div className="grid gap-4">
            <div className="text-center p-2 bg-blue-50 rounded-sm flex items-center justify-start gap-4">
              <div className="text-2xl text-blue-900">{data.newCustomersThisWeek}</div>
            ...
            <div className="text-center p-2 bg-green-50 rounded-sm flex items-center justify-start gap-4">
              <div className="text-2xl text-green-900">{data.repeatCustomersThisWeek}</div>
            ...
            <div className="text-center p-2 bg-purple-50 rounded-sm flex items-center justify-start gap-4">
              <div className="text-2xl text-purple-900">{data.topCustomers.length}</div>
              ...
              <div className="space-y-2">
                {data.topCustomers.map((customer, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                    ...
                    <span className="text-sm text-green-600">{formatCurrency(customer.total)}</span>
                  </div>
                ))}
              </div>
            </div>
