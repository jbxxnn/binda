-- Create simplified business management tables
-- This replaces the complex accounting system with business-friendly tables

-- Categories table (replaces Chart of Accounts)
...
-- Transactions table (replaces Journal Entries)
